...
DTGovi.prototype.isMobile = function() {
	return $(window).width() < 768;
};
DTGovi.prototype.isFileInputSupported = function() {
 ...
 */
DTGovi.prototype.onSwitchToDesktop = function() {
 ...
 */
DTGovi.prototype.onSwitchToMobile = function() {
 ...
 */
DTGovi.prototype.onPageLoad = function() {
	if (this.isMobile()) {
 ...
 */
DTGovi.prototype.onResize = function() {
...
// The global DTGov instance.
window.DTGov = new DTGovi();

/**
 * Do some work when the page first loads.
 */
$(document).ready(function() {
	$(window).resize(function(e) { window.DTGov.onResize(); });
	if (window.DTGov.isFileInputSupported()) {
		$('body').addClass('fileupload');
	} else {
		$('body').addClass('no-fileupload');
	}
	window.DTGov.onPageLoad();
});
