...
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.CLI_HOST;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.CLI_PASSWORD;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.CLI_PORT;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.CLI_USER;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.COPY_DEPLOY_DIR;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.MAVEN_IS_RELEASE_ENABLED;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.MAVEN_PASSWORD;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.MAVEN_REPOSITORY_URL;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.MAVEN_SNAPSHOT_ENABLED;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.MAVEN_USER;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.RHQ_BASE_URL;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.RHQ_PASSWORD;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.RHQ_PLUGIN_NAME;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.RHQ_USER;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.TARGET_CLASSIFIERS;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.TARGET_CLASSIFIER_SEPARATOR;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.TARGET_EXTENDED_TYPE;
import static org.overlord.dtgov.ui.server.services.targets.TargetConstants.TARGET_TYPE;
