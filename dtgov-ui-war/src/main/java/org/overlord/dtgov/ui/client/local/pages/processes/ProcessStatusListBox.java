...
/**
 * Select box that store the Process Status Types.
 * 
 * @author David Virgil Naranjo
 */
public class ProcessStatusListBox extends AbstractFilterListBox {
    ...
    public void clear() {
        ...
        for (ProcessStatusEnum statusEnum : ProcessStatusEnum.values()) {
            this.addItem(statusEnum.name(), statusEnum.name());
        }
    }
