 ...
 */
package org.overlord.dtgov.ui.client.local.services.notification;
...
import org.overlord.dtgov.ui.client.local.events.MouseInEvent.HasMouseInHandlers;
import org.overlord.dtgov.ui.client.local.events.MouseOutEvent;
import org.overlord.dtgov.ui.client.local.events.MouseOutEvent.HasMouseOutHandlers;
 ...
 */
@Templated("/org/overlord/dtgov/ui/client/local/site/dialogs/growl-dialog.html#growl-dialog")
@Dependent
public class NotificationWidget extends Composite implements HasMouseInHandlers, HasMouseOutHandlers {
    ...
    public HandlerRegistration addMouseOutHandler(
            org.overlord.dtgov.ui.client.local.events.MouseOutEvent.Handler handler) {
    ...
    public HandlerRegistration addMouseInHandler(
            org.overlord.dtgov.ui.client.local.events.MouseInEvent.Handler handler) {
