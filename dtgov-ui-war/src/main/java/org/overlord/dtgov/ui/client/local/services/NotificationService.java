...
import org.overlord.dtgov.ui.client.local.animations.FadeOutAnimation;
import org.overlord.dtgov.ui.client.local.animations.MoveAnimation;
import org.overlord.dtgov.ui.client.local.events.MouseInEvent;
import org.overlord.dtgov.ui.client.local.events.MouseOutEvent;
import org.overlord.dtgov.ui.client.local.services.notification.Notification;
import org.overlord.dtgov.ui.client.local.services.notification.NotificationConstants;
import org.overlord.dtgov.ui.client.local.services.notification.NotificationWidget;
...
public class NotificationService {
     ...
     * @param exception
     */
    public final void completeProgressNotification(String uuid, String title, DtgovUiException error) {
        NotificationBean bean = new NotificationBean();
        bean.setUuid(uuid);
    ...
    public void completeProgressNotification(String uuid, String title, Throwable error) {
        if (error instanceof DtgovUiException) {
            completeProgressNotification(uuid, title, (DtgovUiException) error);
        } else {
            completeProgressNotification(uuid, title, new DtgovUiException(error));
        }
    }
